...
import profile from "../assets/profile_pic_portfolio.jpeg";
import { FaLinkedinIn, FaGithub, FaWhatsapp, FaTelegram } from "react-icons/fa";
import resumePath from "../assets/ShrihariD_resume.pdf";
  ...
  return (
    <>
      <nav className="max-w-[1200px] mx-auto my-5 flex flex-col md:flex-row items-center justify-between px-4 md:px-0">
        <div className="w-[65px] h-[65px] rounded-full my-2 p-1 mx-3">
          <motion.img
            src={profile}
            alt=""
